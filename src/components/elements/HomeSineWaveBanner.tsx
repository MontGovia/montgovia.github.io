...
export default function HomeSineWaveBanner() {
    ...
    return (
        <div className="relative w-full h-[55vh] overflow-hidden bg-frosted-glass mt-5 rounded-lg">
            <div className="relative flex flex-col items-center justify-center text-center h-full rounded-lg p-5">
